...
WebUI.switchToFrame(findTestObject('Object Repository/iFrame/inventory'), 10)
...
/***************Create Make no & Part no with current timestamp*****************/
...
GlobalVariable.make = ('Tmake' + currentdate)

System.out.println(GlobalVariable.make)

GlobalVariable.partNo = ('Tpartno' + currentdate)

//System.out.println(GlobalVariable.partNo)
WebUI.verifyElementPresent(findTestObject('Object Repository/InventoryMaintenance/regularInventory/newMake'), 30)

WebUI.setText(findTestObject('Object Repository/InventoryMaintenance/regularInventory/newMake'), GlobalVariable.make)

WebUI.setText(findTestObject('Object Repository/InventoryMaintenance/regularInventory/newPartNumber'), GlobalVariable.partNo)

WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/regularInventory/itemType'), itemType, 
    false)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/mustSerialize'), mustSerialize, 
    false)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/sourceType'), sourceType, 
    false)

WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/narcoticClass'), narcoticClass, 
    false)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/onHandQtyType'), onHandQtyType, 
    false)

WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/fileClaim'), FileClaim, 
    false)

if (mustSerialize.equals('NO')) {
    if (office.equals('ALL')) {
        WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/office'), office, 
            false)
    } else {
...
//WebUI.verifyElementPresent(findTestObject('Object Repository/DynamicXpath/ReusableObject', [('DynamicReusableObject') : xpath]), 
  //  20)
...
WebUI.selectOptionByIndex(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/modifier2'), modifier2, 
...
if (itemType.equals('SALE')) {
    ...
    WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/reorderCode'), reorderCode, 
        false)
}

if (itemType.equals('RENTAL')) {
    WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/status'), status, 
        false)

    WebUI.setText(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/monthlyRate'), monthlyRate)

    WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/depreciationMethod'), 
    ...
    WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventoryDetails/usedItem'), usedItem, 
        false)
...
WebUI.setText(findTestObject('Object Repository/InventoryMaintenance/InventorySearch/make'), GlobalVariable.make)
...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/InventoryMaintenance/InventorySearch/searchResult'), 180, 
    FailureHandling.OPTIONAL)) {
