...
WebUI.verifyElementVisible(findTestObject('Object Repository/InventoryMaintenance/inventoryHeaderTab/specialInventory'))

WebUI.click(findTestObject('Object Repository/InventoryMaintenance/inventoryHeaderTab/specialInventory'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/InventoryMaintenance/InventorySearch/partno'))

WebUI.setText(findTestObject('Object Repository/InventoryMaintenance/InventorySearch/partno'), partNo)

WebUI.selectOptionByLabel(findTestObject('Object Repository/InventoryMaintenance/InventorySearch/titletype'), 'SPECIAL', 
    false)
