...
if (office != '') {
    ...
    WebUI.doubleClick(findTestObject('Object Repository/DynamicXpath/ReusableObject', [('DynamicReusableObject') : xpath])) //WebUI.selectOptionByIndex(findTestObject('Object Repository/Reports/Claim Detail Report/select_Office'), office)
}
...
if (invoicewithClaims != '') {
    WebUI.selectOptionByLabel(findTestObject('Object Repository/Reports/AgingReport/select_InvoicesWithClaims'), invoicewithClaims, 
        false)
}
...
if (invoicewithClaims.equals('With Claims Only')) {
    if (insurance != '') {
        ...
        WebUI.doubleClick(findTestObject('Object Repository/DynamicXpath/ReusableObject', [('DynamicReusableObject') : Ixpath])) //WebUI.selectOptionByIndex(findTestObject('Object Repository/Reports/AgingReport/select_Insurance'), insurance)
    }
}
...
if (claimStatus != '') {
    ...
    WebUI.doubleClick(findTestObject('Object Repository/DynamicXpath/ReusableObject', [('DynamicReusableObject') : csxpath])) //WebUI.selectOptionByIndex(findTestObject('Object Repository/Reports/AgingReport/select_ClaimStatus'), claimStatus)
}
...
if (currentConditions != '') {
    ...
    WebUI.doubleClick(findTestObject('Object Repository/DynamicXpath/ReusableObject', [('DynamicReusableObject') : ccxpath])) //WebUI.selectOptionByIndex(findTestObject('Object Repository/Reports/AgingReport/select_CurrentCondition'), currentConditions)
}
...
if (alertText.contains('internal error')) {
    ...
    if (WebUI.verifyElementPresent(findTestObject('Object Repository/Reports/AgingReport/td_AgingReportByInvoice'), 240, 
