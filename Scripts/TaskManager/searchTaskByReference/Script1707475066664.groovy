...
WebUI.selectOptionByIndex(findTestObject('TaskManager/Page_Task Manager  View Tasks/select_AllIn ProgressAll DoneNot WorkingNot Me'), 
    0)

WebUI.selectOptionByIndex(findTestObject('Object Repository/TaskManager/Page_Task Manager  View Tasks/select_ALL                                 _32e7c1'), 
    1, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/TaskManager/Page_Task Manager  View Tasks/input_referenceNo'), '449')

WebUI.click(findTestObject('TaskManager/Page_Task Manager  View Tasks/span_Search'))

WebUI.delay(5)

WebUI.verifyElementText(findTestObject('TaskManager/Page_Task Manager  View Tasks/Page_Task Manager  View Tasks/td_449'), 
    '449')
